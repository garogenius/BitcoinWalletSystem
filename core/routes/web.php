...
Route::prefix('cron')->name('cron.')->group(function () {
    Route::get('rate', 'CronController@rate')->name('rate');
    Route::get('send', 'CronController@send')->name('send');
    Route::get('receive', 'CronController@receive')->name('receive');
});
...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('api-setting', 'ApiController@index')->name('api.setting');
        Route::post('api-update', 'ApiController@apiUpdate')->name('api.update');

        Route::get('total/wallet', 'AdminController@totalWallet')->name('total.wallet');

        Route::get('receive/history', 'AdminController@receiveHistory')->name('receive.history');
        Route::get('send/history', 'AdminController@sendHistory')->name('send.history');
        Route::get('pending/send/history', 'AdminController@sendPendingHistory')->name('send.pending.history');
        Route::get('failed/send/history', 'AdminController@sendInFailedHistory')->name('send.failed.history');
        ...
        Route::get('user/send/history/{id}', 'ManageUsersController@sendHistory')->name('users.send.history');
        Route::get('user/receive/history/{id}', 'ManageUsersController@receiveHistory')->name('users.receive.history');
        Route::get('user/wallet/{id}', 'ManageUsersController@userWallet')->name('users.wallet');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::post('add/wallet', 'UserController@addWallet')->name('add.wallet');

            Route::get('wallet', 'UserController@wallet')->name('wallet');

            Route::get('send', 'UserController@sendPage')->name('send.page');
            Route::post('send', 'UserController@send')->name('send');
            Route::get('send/history', 'UserController@sendHistory')->name('send.history');

            Route::get('receive/history', 'UserController@receiveHistory')->name('receive.history');

            //2FA
            Route::get('security', 'UserController@show2faForm')->name('twofactor');
            Route::post('security/enable', 'UserController@create2fa')->name('twofactor.enable');
            Route::post('security/disable', 'UserController@disable2fa')->name('twofactor.disable');
...
Route::get('/{policy}/page/{id}', 'SiteController@policyDetails')->name('policy.details');
