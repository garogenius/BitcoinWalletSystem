                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control form-control-lg" type="text" name="cur_text" value="{{$general->cur_text}}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control form-control-lg" type="text" name="cur_sym" value="{{$general->cur_sym}}" disabled>
                                </div>
                            </div>
