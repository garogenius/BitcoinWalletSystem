    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.receive.history')}}">
                    <a href="{{route('admin.receive.history')}}" class="nav-link ">
                        <i class="menu-icon las la-coins"></i>
                        <span class="menu-title">@lang('Receive History')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.send*',3)}}">
                        <i class="menu-icon las la-money-bill-wave"></i>
                        <span class="menu-title">@lang('Send History')</span>
                        @if($pending_send > 0 || $in_completed_send > 0)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.send*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.send.history')}} ">
                                <a href="{{route('admin.send.history')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Completed')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.send.pending.history')}} ">
                                <a href="{{route('admin.send.pending.history')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending')</span>
                                    @if($pending_send)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$pending_send}}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.send.failed.history')}} ">
                                <a href="{{route('admin.send.failed.history')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Failed')</span>
                                    @if($in_completed_send)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$in_completed_send}}</span>
                                    @endif
                                </a>
                            </li>
                        </ul>
