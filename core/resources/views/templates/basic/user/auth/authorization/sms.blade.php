        ...
        <div class="account__section-content bg--title">
            <div class="w-100">
                ...
                <form class="account--form row g-4" method="POST" action="{{route('user.verify.sms')}}">
                    ...
                    <div class="col-sm-12">
                        <label for="code" class="form--label-2">@lang('Your Mobile Number'):  <strong>{{auth()->user()->mobile}}</strong></label>
                    </div>

                    <div class="col-sm-12">
                        <label for="code" class="form--label-2">@lang('Verification Code')</label>
                        <input type="text" name="sms_verified_code" id="code" class="form--control-2">
                    </div>
